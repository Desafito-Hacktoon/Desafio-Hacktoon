...
export const selectContentVariants = cva('z-[10000] min-w-full overflow-y-auto rounded-md border bg-white text-gray-900 shadow-lg animate-in fade-in-0 zoom-in-95');
