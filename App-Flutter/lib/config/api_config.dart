...
class ApiConfig {
  /// URL base da API
  /// Para Docker: use backend-java-core como hostname
  /// Para emulador Android: use 10.0.2.2 ao invés de localhost
  /// Para dispositivo físico: use o IP da máquina na rede local
  static const String baseUrl = 'http://backend-java-core:8080/api';

  /// URL para iOS Simulator
  static const String baseUrlIOS = 'http://backend-java-core:8080/api';

  /// URL para dispositivo físico (altere para o IP da sua máquina)
  static const String baseUrlDevice = 'http://backend-java-core:8080/api';
